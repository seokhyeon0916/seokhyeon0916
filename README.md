...
| Paper    | 채널 상태 정보를 활용한 합성곱 신경망 기반 인간 행동 인식 시스템 구현| 2025.02  | 한국통신학회 등록(19B-P-43) 및 포스터 발표|
| Paper    | 채널 상태 정보 기반 무자각 환자 행동 모니터링 시스템에 관한 연구 | 2025.07  | 한국디지털콘텐츠학회 논문 등록|
</br>
...
### 📖 CLASS 📖 
|학기|과목명|학점|학기|과목명|학점|학기|과목명|학점
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|2020-1|이산구조론|A0|2023-2|디지털신호처리|A+|2025-1|소프트웨어캡스톤디자|-|
|2020-1|자바프로그래밍1|A+|2024-1|운영체제|A0|2025-1|융합정보통신특론|-|
...
|2023-1|통신네트워크시스템|A0|2024-2|빅데이터개론|A0|-|-|-|
|2023-1|C프로그래밍|B+|2024-2|텍스트정보처리|A0|-|-|-|
|2023-1|파이썬과학프로그래밍기초|A0|2024-2|머신러닝응용|B+|-|-|-|
|2023-2|IoT플랫폼설계|A+|2024-2|오픈소스하드웨어응용|A0|-|-|-|
|2023-2|데이터통신|A0|2024-2|융합소프트웨어특강|A+|-|-|-|
|2023-2|임베디드시스템|A+|2025-1|컴퓨터네트워크|-|-|-|-|
|2023-2|소프트웨어특강|B+|2025-1|논리설계및실험|-|-|-|-|
